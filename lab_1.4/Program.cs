...
{ 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a.bA.dA.mD();
            a.cA.eA.mE();
            a.jA.fA.mF();   //в объекте класса а обращаемся к атрибуту доступа, который возвращает значение. Это значение - ссылка на объект другого класса, в котором мы обращаемся к методу
            Console.ReadKey();
